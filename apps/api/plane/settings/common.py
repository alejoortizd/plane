...
CELERY_IMPORTS = (
    ...
    "plane.bgtasks.whatsapp_notification_task",
)
...
EVOLUTION_API_GLOBAL_KEY = os.environ.get("EVOLUTION_API_GLOBAL_KEY", "")
EVOLUTION_INSTANCE_NAME = os.environ.get("EVOLUTION_INSTANCE_NAME", "consultorio")
